...
//    let bundle = Bundle.module.url(forResource: "Shared", withExtension: "string")
    let value = NSLocalizedString(key, tableName: table, bundle: Bundle.module, value: "value", comment: "a-comment")
