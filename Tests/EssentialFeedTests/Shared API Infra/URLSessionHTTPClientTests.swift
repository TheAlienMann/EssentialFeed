...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failssOnRequestError() {
    ...
    private func resultFor(_ values: (data: Data?, response: URLResponse?, error: Error?)? = nil, taskHandler: (HTTPClientTask) -> Void = { _ in }, file: StaticString = #file, line: UInt = #line) -> HTTPClient.Result {
